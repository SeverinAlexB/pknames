...
use egui_graphs::{EdgeProps, DisplayEdge, DisplayNode, Node, DrawContext};
use petgraph::{matrix_graph::Nullable, stable_graph::IndexType, EdgeType};


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Clone, Debug)]
pub struct FancyEdgeShape {
    pub order: usize,
    pub selected: bool,
...
impl<E: Clone> From<EdgeProps<E>> for FancyEdgeShape {
...
impl<N: Clone, E: Clone, Ty: EdgeType, Ix: IndexType, D: DisplayNode<N, E, Ty, Ix>>
    DisplayEdge<N, E, Ty, Ix, D> for FancyEdgeShape
{
    fn is_inside(
        &self,
...
fn is_inside_line(pos_start: Pos2, pos_end: Pos2, pos: Pos2, e: &FancyEdgeShape) -> bool {
